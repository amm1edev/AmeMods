...
class AmeChangeLoaderText(loader.Module):
    """Модуль для изменения текста загрузки хикки. Используйте осторожно!\nАккуратнее при использовании на Lavhost и подобных.Если у вас форк, то, вероятно, все будет работать, но выдаст не критическую ошибку."""

    strings = {"name": "AmeChangeLoaderText"}

    async def chloadertextcmd(self, message):
        """{url} {text} - Задать текст загрузчика. Ссылка обязательна."""
